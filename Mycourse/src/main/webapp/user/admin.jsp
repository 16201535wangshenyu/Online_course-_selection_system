...
<div style=";width:100%;height: 85%;border-bottom: 1px solid black ;">
    ...
    <div style="width:16%;height: 100%;border-right: 1px solid black ;float:left ">
        ...
        <div style="height: 20%;text-align: center;background-color: rgba(218,255,253,0.81)">
            ...
            <div style="position: relative ;top: 35px">
                <a href="/admin/fileupload"  style=" text-decoration:none;width: 60px">教学文件上传</a>
            </div>
        </div>
    ...
    <div style="width: 83.7%;background-color: #e8f9fb;height: 100%;border: 1px solid black ;border-bottom:0px solid black;border-left:0px solid black;float:left ">
        <img src="/images/admin1.jpg" style="width: 100% ;height: 60%;" >
            <div class="block4-2" style="width: 40%;text-decoration: none;font-size: 14px;color: #333333;padding-top: 17px;float: left;overflow: hidden">
               <div style="float: left">
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">关于2017-2018学年第二学期期末补考安排的…</a><div style="height: 12px;"></div>
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">南昌航空大学关于对超过规定学习年限学生给予退学处…</a><div style="height: 12px"></div>
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">关于2017-2018学年第二学期期末补考相关通知</a><div style="height: 12px"></div>
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">关于暑假开放考研自习教室的通知</a><div style="height: 12px"></div>
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">关于2017-2018（二）学期第18周期末考试…</a><div style="height: 12px"></div>
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">关于2018-2019学年第一学期2017级学生…</a><div style="height: 12px"></div>
                   <span  style="color: #2ea1ff">▶</span><a class="block4-2-a" style="padding-left: 10px">关于2017-2018学年第二学期选课人数未超过50人对应的解决方案</a><div style="height: 12px"></div>
               </div>
                <div>
                    <img src="">
                </div>
