...
<div style="width: 100%;height: 10%;border: 0px solid black ;background-color: rgba(218,255,253,0.81)">
    ...
    <div style=";width:100%;height: 85%;border-bottom: 1px solid black ;background-color: rgba(218,255,253,0.81) ">
        ...
        <div style="width: 83.7%;height: 100%;border:0px solid black ;float:left ">
            ...
            <div style="width: 100%;height: 30px;border-bottom: 1px solid dodgerblue;text-align: center">
                添加课程
            </div>
            <div style="text-align: center">
                <form action="/course/add" method="post">
                    ...
                    <br>
                    <input type="text" name="Time_out" placeholder="请输入课程学时">
                    <br>
                    <input type = "textarea" name = "Cintroduction" width="200" height="100" placeholder="课程简介">
                    <br>
                    <input type="number"style="width: 11.2%" min = "0.5" max="4.0" step="0.5" name="Credit" placeholder="学分">
                    <br>
                    <c:if test = "${not empty nmsg}">
                        <div style="color: red">${nmsg}</div>
                        ${nmsg=null}
                    </c:if>
                    ...
                    <div style="float: right;right: 45%;position: relative;">
                        <a href="/user/teacher.jsp">返回</a>
                    </div>
                </form>
            </div>
